...
export const generateGameData = (config: GameConfig): { 
    ...
    const { players, impostorCount, useHintMode, useTrollMode, useArchitectMode, useOracleMode, useNexusMode, selectedCats, history, debugOverrides, isPartyMode } = config;
